...
If you want to use this extension, you need to add the `io.quarkiverse.jdbc-singlestore:quarkus-jdbc-singlestore` extension first to your build file.
...
include::includes/quarkus-jdbc-singlestore.adoc[leveloffset=+1, opts=optional]
